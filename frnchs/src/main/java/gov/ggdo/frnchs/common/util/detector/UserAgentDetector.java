package gov.ggdo.frnchs.common.util.detector;
...
public class UserAgentDetector {
     ...
     */
    public UserAgentDetector(String userAgent, String httpAccept) {
        if (userAgent != null) {
  ...
  //*****************************
    ...
    public String getDeviceName() {
		...
		if (detectAmazonSilk()) {
			deviceName = "AmazonSilk";
		} else if (detectAndroid()) {
			deviceName = "Android";
		} else if (detectArchos()) {
			deviceName = "Archos";
		} else if (detectBada()) {
			deviceName = "Bada";
		} else if (detectBlackBerry()) {
			deviceName = "BlackBerry";
		} else if (detectBrewDevice()) {
			deviceName = "BrewDevice";
		} else if (detectDangerHiptop()) {
			deviceName = "DangerHiptop";
		} else if (detectGameConsole()) {
			deviceName = "GameConsole";
		} else if (detectGamingHandheld()) {
			deviceName = "GamingHandheld";
		} else if (detectGarminNuvifone()) {
			deviceName = "GarminNuvifone";
		} else if (detectGoogleTV()) {
			deviceName = "GoogleTV";
		} else if (detectIos()) {
			deviceName = "IOS";
		} else if (detectKindle()) {
			deviceName = "Kindle";
		} else if (detectNintendo()) {
			deviceName = "Nintendo";
		} else if (detectOperaMobile()) {
			deviceName = "OperaMobile";
		} else if (detectPalmOS()) {
			deviceName = "PalmOS";
		} else if (detectPalmWebOS()) {
			deviceName = "PalmWebOS";
		} else if (detectTizen()) {
			deviceName = "Tizen";
		} else if (detectWebkit()) {
			deviceName = "Webkit";
		} else if (detectWindowsMobile()) {
			deviceName = "WindowsMobile";
		} else if (detectXbox()) {
			deviceName = "Xbox";
		} else {
			deviceName = "UNKNOWN";
