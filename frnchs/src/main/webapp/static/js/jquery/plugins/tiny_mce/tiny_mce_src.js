...
(function(tinymce) {
	...
	tinymce.create('tinymce.Editor', {
		...
		init : function() {
			...
			t.contentsAreaContainer = o.iframeContainer;
		...
		getcontentsAreaContainer : function() {
			return this.contentsAreaContainer;
		},
		...
		destroy : function(s) {
			...
			t.contentsAreaContainer = t.formElement = t.container = t.settings.content_element = t.bodyElement = t.contentDocument = t.contentWindow = null;
