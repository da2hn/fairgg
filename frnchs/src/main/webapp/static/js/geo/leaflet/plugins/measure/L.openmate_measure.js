...
L.vTooltip = L.Tooltip.extend({
	...
	finishContent: function (prefix , subtext) {
		...
		this._container.innerHTML =prefix+' : <span class="leaflet-draw-tooltip-subtext">' + subtext + '</span> <a href="#" class="close"><img src=\"./../gis/js/leaflet/images/ic_tooltip_close.png\"/></a>' + '<br />' ;
		return this;
	},
