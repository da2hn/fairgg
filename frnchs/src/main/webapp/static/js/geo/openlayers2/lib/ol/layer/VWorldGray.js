...
OpenLayers.Layer.VWorldGray = OpenLayers.Class(OpenLayers.Layer.XYZ, {
	name : "VWorld Gray Map",
	url : [
		"${vworldHost}/2d/gray/${version}/${z}/${x}/${y}.png"
	],
	...
	clone : function(obj) {
		if (obj == null) {
			obj = new OpenLayers.Layer.VWorldGray(this.name, this.getOptions());
		}
		obj = OpenLayers.Layer.XYZ.prototype.clone.apply(this, [ obj ]);
		return obj;
	},

	CLASS_NAME : "OpenLayers.Layer.VWorldGray"
});
