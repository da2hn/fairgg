...
Heatmap.Layer = OpenLayers.Class(OpenLayers.Layer, {
    ...
    */
    ...
    /**
    * APIMethod: removeAllSource
    * Removes All heat source from the layer.
    */
    removeAllSource: function() {
        if(this.points.length) {
            for(var i = this.points.length - 1, len = 0; i >= len; i--) {
                OpenLayers.Util.removeItem(this.points, this.points[i]);
            }
        }
    },
