...
<script type="text/javaScript" src="<c:url value="/static/js/ui/myPage/board/noticeList.js"/>"></script>
...
<!-- content -->
		...
		<h5 class="mTitle2">관리자 게시판 관리</h5>
			<div class="mSort1 mt1">
				<form id="searchForm" method="post" onsubmit="return false;">
					...
					<select title="게시판구분" class="select" id="boardMngType" name="boardMngType">
	...
	<h3 class="subtitle forMo">마이페이지</h3>
			...
			<div class="wrap_inner forMo">
				...
				<div class="search">
					<select id="boardMngTypeMob" class="radius" style="width:20%">
						<option value="N">공지사항</option>
						<option value="I">정보지원</option>
					</select>
					
					<select id="schCodeMob" class="radius" style="width:20%">
						<option value=""><c:out value="전체" /></option>
					</select>
				
					<div class="box_search radius" style="width:54%">
