...
<script type="text/javaScript" src="<c:url value="/static/js/ui/myPage/brandInfo/brandInfo.js"/>"></script>
	...
	<div class="content">
		...
		<!-- 				</tr> -->
			...
			<div class="mButton1 right">
				...
				<a href="<c:url value="/myPage/brandInfo/brandInfoList.do" />" class="mBtn1 gray">목록</a>
			</div>
