...
<script type="text/javaScript" src="<c:url value="/static/js/ui/myPage/board/userUnityBoard.js"/>"></script>
		...
		<h5 class="mTitle2">나의 게시글 관리</h5>
			<div class="mSort1 mt1">
				<form id="searchForm" method="post" onsubmit="return false;">
					...
					<select title="구분" class="select" id="schCode" name="schCode">
						<option value="">전체</option>
						<option value="1">게시글</option>
<!-- 						<option value="2">답글</option> -->
				...
				<!-- 	<input type="hidden" id="noticeSn" name="noticeSn" />
					...
					<input type="hidden" id="bbsDc" name="bbsDc"/>
					<input type="hidden" id="bbsNm" name="bbsNm"/>
	...
	<h3 class="subtitle forMo">마이페이지</h3>
			...
			<div class="wrap_inner forMo">
				...
				<form id="searchMobForm" method="post" onsubmit="return false;">
					<input type="hidden" name="pageIndex" value="" />
					...
					<div class="search">
						...
						<select id="schCodeMob" name="schCode" class="radius" style="width:48%;margin-left:2%">
							<option value="">전체</option>
							<option value="1">게시글</option>
<!-- 							<option value="2">답글</option> -->
							<option value="3">댓글</option>
