...
<script type="text/javaScript" src="<c:url value="/static/js/ui/myPage/board/infoView.js"/>"></script>
	...
	<div class="body">
		...
		<input type="hidden" id="answerFntnSportSn" name="answerFntnSportSn" value="<c:out value="${fntnBbs.fntnSportSn}" />" />
			...
			<div class="mButton1 right">
				...
				<a href="${contextPath}/myPage/board/info/infoList.do" class="mBtn1 primary">목록</a>
			</div>
