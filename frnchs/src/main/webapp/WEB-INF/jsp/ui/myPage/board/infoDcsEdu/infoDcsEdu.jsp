...
<script type="text/javaScript" src="<c:url value="/static/js/ui/myPage/board/infoDcsEdu.js"/>"></script>
		...
		<div class="content">
			...
			<form id="searchForm" method="post" onsubmit="return false;">
				...
				<div class="mSort1 mt1">
					...
					<select name="comCode" id="comCode" title="" class="select">
						<option value="">구분</option>
						<option value="1">가맹본부</option>
						<option value="2">가맹거래사</option>
					</select>
					<select name="schSeCode" id="schSeCode" title="" class="select">
		...
		<h3 class="subtitle forMo">마이페이지</h3>
			...
			<div class="wrap_inner forMo">
				...
				<div class="search">
					...
					<select id="comCodeMob" title="" class="radius" style="width:48%;margin-left:2%">
						<option value="">구분</option>
						<option value="1">가맹본부</option>
						<option value="2">가맹거래사</option>
					</select>
					<select id="schSeCodeMob" title="" class="radius" style="width:48%;margin-left:2%">
						<option value="1">브랜드명</option>
						<option value="2">주소</option>
						<option value="3">대표자명</option>
						<option value="4">신청자명</option>
