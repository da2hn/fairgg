...
<div class="content">
	...
	<input type="hidden" name="userSeCode" id="userSeCode" value="${sessionScope.user.userSeCode }"/>
					...
					<div class="modal-body">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<input class="inputModal" type="text" name="edit-dail-selng-am" id="edit-dail-selng-am" required="required" readonly/>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-12">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<textarea rows="4" cols="50" class="inputModal" name="edit-bsn-diary-cn"
									id="edit-bsn-diary-cn" readonly></textarea>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-12">
								...
								<textarea rows="4" cols="50" class="inputModal" name="edit-hedofc-fdbck-cn"
									id="edit-hedofc-fdbck-cn" ></textarea>
							</div>
						</div>
					</div>
...
<!-- //content -->
	...
	<div class="content">
		...
		<div class="btn2 forMo">
			<div class="box_btn block h40 radius white"><button onclick="location.href='mypageExpDiary.html'">목록으로</button></div>
		</div>
	</div>
	</div>
	</div>
