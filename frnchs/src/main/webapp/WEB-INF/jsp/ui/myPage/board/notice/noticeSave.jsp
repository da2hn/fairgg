...
<!-- content -->
		<div class="content">
			...
			<form id="dataForm" method="post" enctype="multipart/form-data">
	            ...
	            <input type="hidden" id="infoSn" name="infoSn" value="<c:out value="${integBbs.infoSn}" />" />
			...
			<div class="mBoard1 mWrite1">
				...
				<tr>
					<th>구분</th>
					<td class="left">
						<select class="select" title="구분" name="boardMngType" id="boardMngType" style="width:130px">
					...
					<td colspan="2">
						<div class="gTextarea">
							...
							nhn.husky.EZCreator.createInIFrame({
							    ...
							    fOnAppLoad:function(){
							    	var contents = `${integBbs.cn}`; <%-- 태그에러 변경 - 21.05.12 --%>
				...
				<table class="tbl_row">
					...
					<tbody>
						<tr>
							<th scope="row">구분</th>
							<td class="left">
								<select class="select" title="구분" name="boardMngType" id="boardMngTypeMob" style="width:120px">
								<option value="">선택하세요</option>
								<option value="N">공지</option>
								<option value="I">정보공개</option>
							</select>
