...
<script>
	...
	function fnReg(){
		...
		if("" == $.trim(qustnrSj)){
			...
			fnGetAjaxData("/sysMngr/insertQustn.ajax", param, function(_data){
	...
	function fnQusnAdd(){
		if($(".qusTr").length >= 100){
			...
			var tr1,tr2
			tr1 = $('<tr class="qusTr" id="qus_'+(qusnNo)+'">																			'
				 + '	<th class="left">설문 문항-'+(qusnNo)+'</th>                                                          '
			...
			tr2 = $('<tr class="ans" id="qus_'+(qusnNo)+'r"><th class="left">선택 답변-'+(qusnNo)+'</th><td colspan="3" id="answer">'
				+	'<div class="box anwTr">																					 '
...
<div class="contents">
		...
		<table summary="서비스 선택, 게시 기간선택, 팝업창 크기, 팝업창 위치, 내용, 팝업사용유무로 구성된 표입니다.">
			...
			<tbody id="question">
				<tr>
					...
					<td class="left" colspan="3">
						<div class="gIt">
							<input type="text" id="qustnrSj" class="it" name="qustnrSj" value="" title="설문 제목">
						</div>
					</td>
				</tr>
				<tr class="notl1">
					...
					<td class="left" colspan="3">
						<div class="gIt">
							<input type="text" class="it" id="qustnrPurps" name="qustnrPurps" value="" title="설문목적">
				...
				<tr>
					...
					<td class="left" colspan="3">
						<div class="gDate1">
							<span class="gIt"><input type="text" readonly="readonly" class="it date" id="beginDe" name="beginDe" value="" title="게시 기간 시작일자"></span>
							<span class="bar">~</span>
							<span class="gIt"><input type="text" readonly="readonly" class="it date" id="endDe" name="endDe" value="" title="게시 기간 종료일자"></span>
	...
	<div class="mButton1 right">
		...
		<a href="#" id="btnReg" class="mBtn1 blue">등록</a> <!--등록, 수정  -->
